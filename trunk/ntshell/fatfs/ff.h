...
#if FF_LFN_UNICODE			/* Unicode string */
#if !FF_USE_LFN
#error FF_LFN_UNICODE must be 0 at non-LFN cfg.
#endif
#ifndef _INC_TCHAR
typedef WCHAR TCHAR;
#define _T(x) L ## x
...
#if FF_USE_LFN							/* Unicode - OEM code conversion */
WCHAR ff_convert (WCHAR chr, UINT dir);	/* OEM-Unicode bidirectional conversion */
WCHAR ff_wtoupper (WCHAR chr);			/* Unicode upper-case conversion */
#if FF_USE_LFN == 3						/* Memory functions */
...
#define FA_MODIFIED			0x20
#define FA_DIRTY			0x40
#endif
...
#if FF_WORD_ACCESS == 1	/* Enable word access to the FAT structure */
