...
#define UDP_OUTPUT_TASK	6
#define NET_MISC_TASK	7
#define FFARCH_TASK	8
#define USBHOST_TASK	9
...
#define SEM_MALLOC	3
#define SEM_IF_BTUSB_SBUF_READY	4
#define SEM_IF_BTUSB_RBUF_READY	5
