...
/*static*/ STK_T _kernel_stack_USBHOST_TASK[COUNT_STK_T(USBHOST_STACK_SIZE)];
...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	...
	{ (TA_FPU), (intptr_t)(0), (TASK)(usbhost_main), INT_PRIORITY(USBHOST_PRIORITY), ROUND_STK_T(USBHOST_STACK_SIZE), _kernel_stack_USBHOST_TASK, "usbhost_main" },
...
const ID _kernel_torder_table[TNUM_STSKID] = { 
	TSKID_tTask_LogTask_Task, NET_TIMER_TASK, ETHER_OUTPUT_TASK, ETHER_INPUT_TASK, TCP_OUTPUT_TASK, UDP_OUTPUT_TASK, NET_MISC_TASK, FFARCH_TASK, USBHOST_TASK, NTSHELL_TASK, ECHONET_SVC_TASK, ECHONET_UDP_TASK, ECHONET_MAIN_TASK, MAIN_TASK
};
...
const SEMINIB _kernel_seminib_table[TNUM_SSEMID] = {
	...
	{ (TA_NULL), (1), (1) },
	{ (TA_TPRI), (1), (1) },
	{ (TA_TPRI), (NUM_IF_BTUSB_TXBUF), (NUM_IF_BTUSB_TXBUF) },
	{ (TA_TPRI), (0), (NUM_IF_BTUSB_RXBUF) },
	{ (TA_TPRI), (1), (1) },
...
const INTINIB _kernel_intinib_table[TNUM_CFG_INTNO] = {
	...
	{ (INTNO_USB), (INTATR_USB), (INTPRI_USB) }
};
...
FP _kernel_inh_table[TNUM_INHNO] = {
	...
	/* 0x049 */ (FP)(usb_interrupt_handler),
