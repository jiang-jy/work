...
/*static*/ STK_T _kernel_stack_TSKID_tTask_Task[COUNT_STK_T(81920)];
...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	{ (TA_ACT), (intptr_t)(&tTask_INIB_tab[0]), (TASK)(tTask_start), INT_PRIORITY(1), ROUND_STK_T(81920), _kernel_stack_TSKID_tTask_Task, "tTask_start" },
